...
author: "Team Name: Akarsh, Matt, Matthew, Julian"
date: "`r Sys.Date()`"
...
plastic_data_all %>%
  ...
  group_by(region) %>%
  summarise(medPct = median(pct_mismanaged_plastic_ocean, na.rm=TRUE))
```
...
plastic_data_all %>% rename(pop=population, reg=region, mp=mismanaged_plastic, mp_ocean=mismanaged_plastic_ocean)
